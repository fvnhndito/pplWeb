    ...
    <body class="bg-gray-50 min-h-screen flex items-center justify-center p-6">
        <div class="w-full max-w-md">
            <div class="text-center mb-8">
                <h1 class="text-slate-900 text-3xl font-semibold mb-2">PLEASE LOGIN</h1>
                <p class="text-sm text-gray-600 mt-2">Welcome back! Please login to your account</p>
            </div>

            <div class="p-6 sm:p-8 rounded-2xl bg-white border border-gray-200 shadow-sm">
            <h2 class="text-slate-900 text-center text-2xl font-semibold mb-8">Sign in</h2>
            <form class="space-y-6">
              ...
              <div class="!mt-8">
                <button type="button" class="w-full py-3 px-4 text-[15px] font-medium tracking-wide rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none cursor-pointer">
                  Sign in
                </button>
              </div>
              <p class="text-slate-900 text-sm !mt-6 text-center">Don't have an account? <a href="{{ route('register') }}" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a></p>
            </form>
          </div>
